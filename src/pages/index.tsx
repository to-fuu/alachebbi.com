...
import { HiChevronDoubleDown, HiOutlineDocumentText } from 'react-icons/hi';
      ...
      <main className='max-w-[100vw] overflow-x-hidden '>
        <section className='overflow-hidden relative bg-gradient-to-br text-gray-200 selection:bg-white selection:text-gray-900 before:absolute before:inset-0 before:animate-hue-rotate before:bg-[url(/images/mesh-1.webp)] before:bg-cover before:opacity-100 before:mix-blend-screen bg-black '>
              ...
              <h1 className='group mt-4 flex flex-col leading-[1.1] justify-center items-center '>
                <div className='mb-4 text-3xl font-bold text-center transition duration-300 scale-90 text-opacity-60'>
                  <Image
                    ...
                    width={48}
                    height={48}
                    className='inline w-12 h-12 mr-4 rounded-full object-cover object-top'
                    alt='Ala Chebbi'
                  />
                  Howdy 👋 I&apos;m Ala,
                </div>
          ...
          <div className='relative flex w-full mt-20 '>
            <motion.div
              ...
              className='mx-auto max-h-[720px] overflow-hidden'
            >
              <FadeIn
        ...
        >
          ...
          <FadeIn bounce={0} duration={0.5} distance={40} once={false}>
            <p className='max-w-2xl mt-20 mb-4 text-xl text-gray-400'>
              Welcome to my portfolio! I&apos;m Ala, a passionate programmer,
              gamer, artist and UI aspiring designer. I currently work as a
              Unity developer at{' '}
              <a
                href='https://questt.com'
                target={'_blank'}
                rel='noreferrer noopener'
                className='text-teal-600 underline cursor-newtab'
              >
                Questt
              </a>
              .
              <br /> My favourite and most used frameworks are{' '}
              <em className='font-medium'>Next.js</em> and{' '}
              <em className='font-medium'>TailwindCSS</em> for frontend
              development and <em className='font-medium'>Unity3D</em> for game
              development.
            </p>
          </FadeIn>
            ...
            <div className='flex p-4 mt-20 text-white duration-300 hover:bg-blue-500/20 rounded-xl'>
              ...
              <div className=''>
                ...
                <p className='mt-4 text-gray-400'>
                  Made with React, plain HTML and CSS or Wordpress; Landing page
                  or E-Commerce, the choice is yours. Performance and SEO are
                  guaranteed!
                </p>
              </div>
            </div>
          ...
          <FadeIn bounce={0} duration={0.5} distance={40} once={false}>
            <div className='flex p-4 mt-8 text-white duration-300 hover:bg-pink-500/20 rounded-xl'>
              ...
              <div className=''>
                ...
                <p className='mt-4 text-gray-400'>
                  I will help you turn your game idea into reality or help you
                  implementing a game mechanic in Unity
                </p>
              </div>
            </div>
          </FadeIn>
          ...
          <div className='grid gap-4 mt-12 mb-20 sm:grid-cols-2 lg:grid-cols-3 layout'>
            ...
            <Link href='/projects'>
              <a className='relative flex flex-col items-start justify-start w-full h-full p-12 text-gray-200 duration-300 active:scale-95 active:opacity-75 hover:shadow-xl hover:shadow-red-600/20 overflow-hidden group hover:-translate-y-2 rounded-2xl hover:text-gray-200'>
                ...
                <span className='relative max-w-xs text-3xl font-bold transition-all duration-300 group-hover:text-base group-hover:font-normal group-hover:opacity-75'>
                  See {remaining} more...
                </span>
                <span className='relative max-w-xs text-3xl font-bold transition-all duration-300 opacity-0 group-hover:opacity-100'>
        ...
        <section className='pt-16 bg-gray-900/50 sm:pt-32 sm:pb-16'>
          <div className='layout'>
                ...
                <div className=''>
                  ...
                  <ul className='mt-8 space-y-4'>
                    <li className='flex flex-col space-y-1'>
                      ...
                      <span className='text-lg font-medium text-gray-400'>
                        Brandbox{' '}
                        <span className='text-white bg-amber-500 rounded-md px-2 text-xs py-0.5 ml-1 -translate-y-px inline-block'>
                          CURRENT
                        </span>{' '}
                      </span>
            ...
            >
              <Link href={'/resume'}>
                <a className='relative inline-flex items-center gap-4 text-xl font-medium text-white transition-all duration-300 h-14 bg-rose-600 hover:shadow-xl hover:text-opacity-75 active:scale-95 active:shadow-none active:text-opacity-50 hover:shadow-rose-600/30 rounded-2xl px-7 hover:bg-rose-500'>
                  See Full Resume
                  <HiOutlineDocumentText />
                </a>
              </Link>
        ...
        <section
          className='relative pt-16 bg-gradient-to-b from-gray-900/50 to-black sm:py-32'
          id='blog'
        >
          <div className='layout '>
            <FadeIn
            ...
            >
              <div className='relative max-w-screen-xl py-20 mx-auto mt-12 sm:mt-20 bg-gradient-to-b from-gray-900/50 to-transparent rounded-3xl'>
                <Swiper slidesPerView={'auto'} className=' w-full h-[320px]'>
                  {testimonials.map(
                    ({ initials, name, review, thumb, title }, i) => (
                      <SwiperSlide key={i}>
                        <div
                          ...
                          <div className='flex items-center mt-auto'>
                            {thumb ? (
                              <Image
                                ...
                                src={thumb.url}
                                placeholder='blur'
                                blurDataURL={thumb.blurUpThumb}
                                className='mr-4 rounded-full w-12 h-12 object-cover'
                                alt={name}
                              />
                            ) : (
                              <div
                                className='grid w-12 h-12 mr-4 text-xl font-black text-gray-500 bg-gray-200 rounded-full place-items-center'
                                children={initials}
                              />
                            )}
                            <div className='ml-8'>

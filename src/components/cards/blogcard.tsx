...
(
    <div className="block overflow-clip rounded-2xl shadow-md bg-gray-800 hover:shadow-xl hover:-translate-y-1 duration-300 cursor-newtab">
        ...
        <div className="p-4 relative overflow-clip before:bg-[url(/images/mesh-1.webp)] before:absolute before:inset-0 before:bg-cover before:mix-blend-overlay before:opacity-100 before:animate-hue-rotate">

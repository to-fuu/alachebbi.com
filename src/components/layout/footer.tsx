...
export const Footer = () => (
    <footer id="footer" className="w-screen overflow-x-clip pb-12 dark:bg-black">
        <div className="max-w-screen-2xl  pt-16 sm:pt-0 pb-12 mx-auto xl:px-8">
            <FadeIn bounce={0} duration={0.5} distance={40} once={false}>
                <div className="max-w-screen-xl mx-auto text-white py-20 xl:rounded-3xl overflow-clip before:rounded-3xl text-center  bg-gradient-to-br from-blue-600 to-green-400 before:bg-[url(/images/mesh-1.webp)] before:absolute before:inset-0 before:bg-cover before:mix-blend-overlay before:opacity-100  relative before:animate-hue-rotate">
                    ...
                    <a href="https://www.linkedin.com/in/ala-chebbi-32266b168/" target={'_blank'} rel='noreferrer noopener' className='h-16 group shadow font-medium items-center hover:gap-6 gap-4 px-7 inline-flex rounded-2xl hover:opacity-100 opacity-80 transition-all text-xl relative mt-12 duration-300 bg-white text-blue-700'>
                        Send me a message
            ...
            <div className="pt-12 lg:mt-12 border-t border-white/25 sm:items-center sm:justify-between gap-12 flex justify-center text-center lg:text-left flex-col-reverse lg:flex-row">
                <div className="">
                    <p className="text-gray-700 dark:text-gray-400">Ala Chebbi &copy; 2022 | Made with <Tooltip content="Next.js v12"><SiNextdotjs className="inline-block mx-1 text-lg" /></Tooltip>, <Tooltip content="React v17"><SiReact className="inline-block mx-1 text-lg" /></Tooltip> ,<Tooltip content="TailwindCSS v3"><SiTailwindcss className="inline-block mx-1" /></Tooltip>, <Tooltip content="Framer Motion v5"><SiFramer className="inline-block mx-1" /></Tooltip> ,<Tooltip content="Typescript"><SiTypescript className="inline-block mx-1" /></Tooltip> ,  <Tooltip content="Dato CMS"><SiDatocms className="inline-block mx-1" /></Tooltip></p>
                    <a href="https://github.com/to-fuu/alachebbi.com" target={'_blank'} rel='noreferrer noopener' className="text-gray-700 dark:text-gray-400 inline-flex gap-1 items-center underline">View Source <ImArrowRight2 className="text-xs" /> </a>
                </div>
                <div className="flex justify-center mt-6 space-x-6 sm:justify-end sm:mt-0 text-xl text-gray-700 dark:text-gray-400">
